 ...
 * @since NepalBuzz 0.1
 */
function nepalbuzz_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function nepalbuzz_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since NepalBuzz 0.1
 */
function nepalbuzz_sanitize_page( $input ) {
 ...
 * @since NepalBuzz 0.1
 */
function nepalbuzz_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function nepalbuzz_sanitize_number_range( $number, $setting ) {
 ...
 * @since NepalBuzz 0.1
 */
function nepalbuzz_sanitize_footer_code( $input ) {
 ...
 *
 * @see nepalbuzz_sanitize_select()               https://developer.wordpress.org/reference/functions/nepalbuzz_sanitize_select/
 ...
 */
function nepalbuzz_sanitize_select( $input, $setting ) {
 ...
 * @since NepalBuzz 0.1
 */
function nepalbuzz_sanitize_important_link() {
	return false;
}
